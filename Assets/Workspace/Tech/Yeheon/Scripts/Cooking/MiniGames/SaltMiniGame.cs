...
public class SaltMiniGame : MonoBehaviour
{
    [Header("UI")]
    ...
    [SerializeField] private float successRange = 0.15f;

    [Header("Speed")]
    [SerializeField] private float shrinkSpeed = 1.5f;
    [SerializeField] private float speedIncreasePerSuccess = 0.2f;

    [Header("Difficulty")]
    [SerializeField] private float rangeDecreasePerSuccess = 0.01f;

    [Header("Success Count")]
    [SerializeField] private int minSuccessCount = 3;
    [SerializeField] private int maxSuccessCount = 6;
